...
with Session() as session:
    ...
    for driver in drivers:
        new_driver = Driver(driver_name = driver['driver'], driver_points = driver['points'], driver_team = driver['team'], driver_engine = driver['engine'], driver_nextgp = driver['nextGP'])
