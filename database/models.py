...
class Grandprix(Base):
    ...
    max1: Mapped[int] = mapped_column(Integer, nullable=True)
    max2: Mapped[int] = mapped_column(Integer, nullable=True)
    max3: Mapped[int] = mapped_column(Integer, nullable=True)
...
class Team(Base):
    ...
    third: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey('users.id'), nullable=True)
    logo: Mapped[str] = mapped_column(String(60), nullable=True)
    captain: Mapped[int] = mapped_column(Integer, ForeignKey('users.id'), nullable=True)
    background_color: Mapped[str] = mapped_column(String(6), nullable=True)
    text_color: Mapped[str] = mapped_column(String(6), nullable=True)
    number_color: Mapped[str] = mapped_column(String(6), nullable=True)
    number_font: Mapped[str] = mapped_column(String(60), nullable=True)
    number_italic: Mapped[bool] = mapped_column(Boolean, nullable=True)
...
class Point(Base):
    ...
    actual_team: Mapped[int] = mapped_column(Integer)
